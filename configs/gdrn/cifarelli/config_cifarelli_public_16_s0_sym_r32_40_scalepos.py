...
SEED = 0
OUTPUT_DIR = "output/gdrn/cifarelli/config_cifarelli_public_16_s0_sym_r32_40_scalepos.py"
INPUT = dict(
    SEGMENT=False,
    BLACK_PAD=False,
    RND_BG=False,
...
DATASETS = dict(
    TRAIN=("cifarelli_train_public",), # TODO: MODIFY THE SECOND TRAIN SET
    TEST=("cifarelli_test_public",),
    # DET_FILES_TEST=("datasets/custom/epose/test/test_bboxes/bbox_faster_all.json",), TODO: GENERATE FILE USING YOLO ?
    SYM_OBJS=["tubetto_m1200", "ugello_l80_99", "dado_m5", "vite_65", "vite_20"]
)
